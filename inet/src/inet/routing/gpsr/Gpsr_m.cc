//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/gpsr/Gpsr.msg.
//
...
std::string GpsrOptionDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    GpsrOption *pp = omnetpp::fromAnyPtr<GpsrOption>(object); (void)pp;
    switch (field) {
        case FIELD_routingMode: return enum2string(static_cast<int>(pp->getRoutingMode()), "inet::GpsrForwardingMode");

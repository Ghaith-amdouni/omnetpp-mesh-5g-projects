//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/bgpv4/bgpmessage/BgpHeader.msg.
//
...
std::string BgpAsPathSegmentDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    BgpAsPathSegment *pp = omnetpp::fromAnyPtr<BgpAsPathSegment>(object); (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::bgp::BgpPathSegmentType");
...
std::string BgpHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::bgp::BgpType");
        default: return "";
    }
}
...
std::string BgpUpdatePathAttributesDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_typeCode: return enum2string(static_cast<int>(pp->getTypeCode()), "inet::bgp::BgpUpdateAttributeTypeCode");
        case FIELD_length: return ulong2string(pp->getLength());
        default: return "";
    }
}
...
std::string BgpUpdatePathAttributesOriginDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    BgpUpdatePathAttributesOrigin *pp = omnetpp::fromAnyPtr<BgpUpdatePathAttributesOrigin>(object); (void)pp;
    switch (field) {
        case FIELD_value: return enum2string(static_cast<int>(pp->getValue()), "inet::bgp::BgpSessionType");
        default: return "";
    }
}
...
void BgpUpdateMessage::setPathAttributes(size_t k, BgpUpdatePathAttributes * pathAttributes)
{
    ...
    if (this->pathAttributes[k] != nullptr && this->pathAttributes[k]->isOwnedObject()) dropAndDelete((omnetpp::cOwnedObject*)this->pathAttributes[k]); else delete this->pathAttributes[k];
    this->pathAttributes[k] = pathAttributes;
    if (this->pathAttributes[k] != nullptr && this->pathAttributes[k]->isOwnedObject()) take((omnetpp::cOwnedObject*)this->pathAttributes[k]);
}
...
void BgpUpdateMessage::insertPathAttributes(size_t k, BgpUpdatePathAttributes * pathAttributes)
{
    ...
    if (pathAttributes2[k] != nullptr && pathAttributes2[k]->isOwnedObject()) take((omnetpp::cOwnedObject*)pathAttributes2[k]);
    for (i = k + 1; i < newSize; i++)

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/ospfv2/Ospfv2Packet.msg.
//
...
std::string Ospfv2LsaHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_lsType: return enum2string(static_cast<int>(pp->getLsType()), "inet::ospfv2::Ospfv2LsaType");
        ...
        case FIELD_lsCrcMode: return enum2string(static_cast<int>(pp->getLsCrcMode()), "inet::CrcMode");
...
std::string Ospfv2LinkDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::ospfv2::LinkType");
...
void Ospfv2LinkStateUpdatePacket::setOspfLSAs(size_t k, Ospfv2Lsa * ospfLSAs)
{
    ...
    if (this->ospfLSAs[k] != nullptr && this->ospfLSAs[k]->isOwnedObject()) dropAndDelete((omnetpp::cOwnedObject*)this->ospfLSAs[k]); else delete this->ospfLSAs[k];
    this->ospfLSAs[k] = ospfLSAs;
    if (this->ospfLSAs[k] != nullptr && this->ospfLSAs[k]->isOwnedObject()) take((omnetpp::cOwnedObject*)this->ospfLSAs[k]);
}
...
void Ospfv2LinkStateUpdatePacket::insertOspfLSAs(size_t k, Ospfv2Lsa * ospfLSAs)
{
    ...
    if (ospfLSAs2[k] != nullptr && ospfLSAs2[k]->isOwnedObject()) take((omnetpp::cOwnedObject*)ospfLSAs2[k]);
    for (i = k + 1; i < newSize; i++)

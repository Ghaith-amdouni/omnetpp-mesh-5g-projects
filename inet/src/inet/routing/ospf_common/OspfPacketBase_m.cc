//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/ospf_common/OspfPacketBase.msg.
//
...
std::string OspfPacketBaseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::ospf::OspfPacketType");

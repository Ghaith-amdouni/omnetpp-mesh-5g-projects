//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/aodv/AodvControlPackets.msg.
//
...
std::string AodvControlPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    AodvControlPacket *pp = omnetpp::fromAnyPtr<AodvControlPacket>(object); (void)pp;
    switch (field) {
        case FIELD_packetType: return enum2string(static_cast<int>(pp->getPacketType()), "inet::aodv::AodvControlPacketType");
        default: return "";
    }
}

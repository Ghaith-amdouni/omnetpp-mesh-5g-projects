//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/dymo/Dymo.msg.
//
...
std::string AddressBlockDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_metricType: return enum2string(static_cast<int>(pp->getMetricType()), "inet::dymo::DymoMetricType");

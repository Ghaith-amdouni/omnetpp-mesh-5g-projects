//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/routing/eigrp/EigrpTimer.msg.
//
...
std::string EigrpTimerDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    EigrpTimer *pp = omnetpp::fromAnyPtr<EigrpTimer>(object); (void)pp;
    switch (field) {
        case FIELD_timerKind: return enum2string(static_cast<int>(pp->getTimerKind()), "EigrpTimerType");
        default: return "";
    }
}

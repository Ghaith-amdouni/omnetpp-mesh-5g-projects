//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/networklayer/wiseroute/WiseRouteHeader.msg.
//
...
std::string WiseRouteHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_headerKind: return enum2string(static_cast<int>(pp->getHeaderKind()), "inet::WiseRouteMsgType");

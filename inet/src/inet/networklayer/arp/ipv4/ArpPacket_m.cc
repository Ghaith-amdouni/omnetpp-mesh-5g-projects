//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/networklayer/arp/ipv4/ArpPacket.msg.
//
...
std::string ArpPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    ArpPacket *pp = omnetpp::fromAnyPtr<ArpPacket>(object); (void)pp;
    switch (field) {
        case FIELD_opcode: return enum2string(static_cast<int>(pp->getOpcode()), "inet::ArpOpcode");

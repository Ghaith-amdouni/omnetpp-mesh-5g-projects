//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/networklayer/ipv4/Ipv4Header.msg.
//
...
std::string Ipv4OptionTimestampDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Ipv4OptionTimestamp *pp = omnetpp::fromAnyPtr<Ipv4OptionTimestamp>(object); (void)pp;
    switch (field) {
        case FIELD_flag: return enum2string(static_cast<int>(pp->getFlag()), "inet::TimestampFlag");

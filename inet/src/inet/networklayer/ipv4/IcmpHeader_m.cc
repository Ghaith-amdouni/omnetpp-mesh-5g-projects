//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/networklayer/ipv4/IcmpHeader.msg.
//
...
std::string IcmpHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    IcmpHeader *pp = omnetpp::fromAnyPtr<IcmpHeader>(object); (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::IcmpType");

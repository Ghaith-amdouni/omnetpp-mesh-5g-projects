//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/networklayer/common/EchoPacket.msg.
//
...
std::string EchoPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    EchoPacket *pp = omnetpp::fromAnyPtr<EchoPacket>(object); (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::EchoProtocolType");

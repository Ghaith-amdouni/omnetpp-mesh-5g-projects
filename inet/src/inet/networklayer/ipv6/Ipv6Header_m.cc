//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/networklayer/ipv6/Ipv6Header.msg.
//
...
void Ipv6Header::setExtensionHeader(size_t k, Ipv6ExtensionHeader * extensionHeader)
{
    ...
    if (this->extensionHeader[k] != nullptr && this->extensionHeader[k]->isOwnedObject()) take((omnetpp::cOwnedObject*)this->extensionHeader[k]);
}
...
void Ipv6Header::insertExtensionHeader(size_t k, Ipv6ExtensionHeader * extensionHeader)
{
    ...
    if (extensionHeader2[k] != nullptr && extensionHeader2[k]->isOwnedObject()) take((omnetpp::cOwnedObject*)extensionHeader2[k]);
...
void Ipv6Header::eraseExtensionHeader(size_t k)
{
    ...
    for (i = k; i < newSize; i++)
        extensionHeader2[i] = this->extensionHeader[i+1];
    if (this->extensionHeader[k] != nullptr && this->extensionHeader[k]->isOwnedObject()) dropAndDelete((omnetpp::cOwnedObject*)this->extensionHeader[k]); else delete this->extensionHeader[k];
    delete [] this->extensionHeader;
    this->extensionHeader = extensionHeader2;
    extensionHeader_arraysize = newSize;
}
...
std::string Ipv6HeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_protocolId: return enum2string(static_cast<int>(pp->getProtocolId()), "inet::IpProtocolId");

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/common/PacketEventTag.msg.
//
...
std::string PacketEventDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    PacketEvent *pp = omnetpp::fromAnyPtr<PacketEvent>(object); (void)pp;
    switch (field) {
        case FIELD_kind: return enum2string(static_cast<int>(pp->getKind()), "inet::PacketEventKind");

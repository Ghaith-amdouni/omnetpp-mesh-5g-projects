//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/common/ProtocolTag.msg.
//
...
std::string DispatchProtocolReqDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    DispatchProtocolReq *pp = omnetpp::fromAnyPtr<DispatchProtocolReq>(object); (void)pp;
    switch (field) {
        case FIELD_servicePrimitive: return enum2string(static_cast<int>(pp->getServicePrimitive()), "inet::ServicePrimitive");
        default: return "";
    }
}

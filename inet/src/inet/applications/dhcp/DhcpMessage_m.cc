//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/applications/dhcp/DhcpMessage.msg.
//
...
std::string DhcpOptionsDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    DhcpOptions *pp = omnetpp::fromAnyPtr<DhcpOptions>(object); (void)pp;
    switch (field) {
        case FIELD_messageType: return enum2string(static_cast<int>(pp->getMessageType()), "inet::DhcpMessageType");
        case FIELD_hostName: return oppstring2string(pp->getHostName());
        case FIELD_parameterRequestList: return enum2string(static_cast<int>(pp->getParameterRequestList(i)), "inet::DhcpOptionCode");
...
std::string DhcpMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    DhcpMessage *pp = omnetpp::fromAnyPtr<DhcpMessage>(object); (void)pp;
    switch (field) {
        case FIELD_op: return enum2string(static_cast<int>(pp->getOp()), "inet::DhcpOpcode");

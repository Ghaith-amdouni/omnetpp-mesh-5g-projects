//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/ieee80211/mgmt/Ieee80211MgmtFrame.msg.
//
...
std::string Ieee80211AuthenticationFrameDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_statusCode: return enum2string(static_cast<int>(pp->getStatusCode()), "inet::ieee80211::Ieee80211StatusCode");

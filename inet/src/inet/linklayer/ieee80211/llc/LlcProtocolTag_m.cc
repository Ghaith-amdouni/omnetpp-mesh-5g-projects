//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/ieee80211/llc/LlcProtocolTag.msg.
//
...
std::string LlcProtocolTagDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LlcProtocolTag *pp = omnetpp::fromAnyPtr<LlcProtocolTag>(object); (void)pp;
    switch (field) {
        case FIELD_protocolId: return enum2string(static_cast<int>(pp->getProtocolId()), "inet::ieee80211::LlcProtocolId");
        default: return "";
    }
}

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/ieee80211/mac/Ieee80211Frame.msg.
//
...
std::string Ieee80211MacTrailerDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_fcsMode: return enum2string(static_cast<int>(pp->getFcsMode()), "inet::FcsMode");
        default: return "";
    }
}
...
std::string Ieee80211MacHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Ieee80211MacHeader *pp = omnetpp::fromAnyPtr<Ieee80211MacHeader>(object); (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::ieee80211::Ieee80211FrameType");
...
std::string Ieee80211DataHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_ackPolicy: return enum2string(static_cast<int>(pp->getAckPolicy()), "inet::ieee80211::AckPolicy");

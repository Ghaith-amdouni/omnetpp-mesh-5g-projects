//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/ieee8021as/GptpPacket.msg.
//
...
std::string GptpBaseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_messageType: return enum2string(static_cast<int>(pp->getMessageType()), "inet::GptpMessageType");
...
std::string GptpTlvDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    GptpTlv *pp = omnetpp::fromAnyPtr<GptpTlv>(object); (void)pp;
    switch (field) {
        case FIELD_tlvType: return enum2string(static_cast<int>(pp->getTlvType()), "inet::GptpTlvType");

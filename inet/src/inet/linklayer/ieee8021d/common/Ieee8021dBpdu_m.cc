//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg.
//
...
std::string BpduBaseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    BpduBase *pp = omnetpp::fromAnyPtr<BpduBase>(object); (void)pp;
    switch (field) {
        case FIELD_protocolIdentifier: return enum2string(static_cast<int>(pp->getProtocolIdentifier()), "inet::BpduProtocolIdentifier");
        case FIELD_protocolVersionIdentifier: return enum2string(static_cast<int>(pp->getProtocolVersionIdentifier()), "inet::BpduProtocolVersionIdentifier");
        case FIELD_bpduType: return enum2string(static_cast<int>(pp->getBpduType()), "inet::BpduType");
        default: return "";
    }
}

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/csmaca/CsmaCaMacHeader.msg.
//
...
std::string CsmaCaMacHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    CsmaCaMacHeader *pp = omnetpp::fromAnyPtr<CsmaCaMacHeader>(object); (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::CsmaCaMacHeaderType");

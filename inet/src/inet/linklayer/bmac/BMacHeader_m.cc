//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/linklayer/bmac/BMacHeader.msg.
//
...
std::string BMacHeaderBaseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::BMacType");
        default: return "";
    }
}

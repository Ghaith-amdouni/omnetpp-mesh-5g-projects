//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/transportlayer/rtp/RtcpPacket.msg.
//
...
std::string RtcpPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_packetType: return enum2string(static_cast<int>(pp->getPacketType()), "inet::rtp::RtcpPacketType");

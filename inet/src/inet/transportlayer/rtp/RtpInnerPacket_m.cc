//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/transportlayer/rtp/RtpInnerPacket.msg.
//
...
std::string RtpInnerPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    RtpInnerPacket *pp = omnetpp::fromAnyPtr<RtpInnerPacket>(object); (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "inet::rtp::RtpInpType");

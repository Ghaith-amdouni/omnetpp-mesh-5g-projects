//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/transportlayer/contract/tcp/TcpCommand.msg.
//
...
std::string TcpErrorInfoDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    TcpErrorInfo *pp = omnetpp::fromAnyPtr<TcpErrorInfo>(object); (void)pp;
    switch (field) {
        case FIELD_errorCode: return enum2string(static_cast<int>(pp->getErrorCode()), "inet::TcpErrorCode");

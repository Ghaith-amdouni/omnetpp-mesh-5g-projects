//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/physicallayer/wired/ethernet/EthernetPhyHeader.msg.
//
...
std::string EthernetFragmentPhyHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    EthernetFragmentPhyHeader *pp = omnetpp::fromAnyPtr<EthernetFragmentPhyHeader>(object); (void)pp;
    switch (field) {
        case FIELD_preambleType: return enum2string(static_cast<int>(pp->getPreambleType()), "inet::physicallayer::EthernetPhyHeaderType");

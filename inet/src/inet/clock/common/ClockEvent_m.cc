//
// Generated file, do not edit! Created by opp_msgtool 6.3 from inet/clock/common/ClockEvent.msg.
//
...
std::string ClockEventDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_overdueClockEventHandlingMode: return enum2string(static_cast<int>(pp->getOverdueClockEventHandlingMode()), "inet::OverdueClockEventHandlingMode");
        default: return "";
    }
}

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/mec/ualcmp/messages/UalcmpMessages.msg.
//
...
UalcmpMessageDescriptor::UalcmpMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::UalcmpMessage)), "omnetpp::cMessage")
{
...
CreateContextApp::CreateContextApp(const char *name, short kind) : ::simu5g::UalcmpMessage(name, kind)
{
}

CreateContextApp::CreateContextApp(const CreateContextApp& other) : ::simu5g::UalcmpMessage(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::simu5g::UalcmpMessage::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::simu5g::UalcmpMessage::parsimPack(b);
...
{
    ::simu5g::UalcmpMessage::parsimUnpack(b);
...
CreateContextAppDescriptor::CreateContextAppDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::CreateContextApp)), "simu5g::UalcmpMessage")
{
    propertyNames = nullptr;
}
...
CreateContextAppAck::CreateContextAppAck(const char *name, short kind) : ::simu5g::UalcmpMessage(name, kind)
{
}

CreateContextAppAck::CreateContextAppAck(const CreateContextAppAck& other) : ::simu5g::UalcmpMessage(other)
{
    copy(other);
}
...
CreateContextAppAckDescriptor::CreateContextAppAckDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::CreateContextAppAck)), "simu5g::UalcmpMessage")
{
    propertyNames = nullptr;
}
...
DeleteContextAppMessage::DeleteContextAppMessage(const char *name, short kind) : ::simu5g::UalcmpMessage(name, kind)
{
}

DeleteContextAppMessage::DeleteContextAppMessage(const DeleteContextAppMessage& other) : ::simu5g::UalcmpMessage(other)
{
    copy(other);
}
...
DeleteContextAppMessageDescriptor::DeleteContextAppMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeleteContextAppMessage)), "simu5g::UalcmpMessage")
{
    propertyNames = nullptr;
}
...
DeleteContextAppAckMessage::DeleteContextAppAckMessage(const char *name, short kind) : ::simu5g::UalcmpMessage(name, kind)
{
}

DeleteContextAppAckMessage::DeleteContextAppAckMessage(const DeleteContextAppAckMessage& other) : ::simu5g::UalcmpMessage(other)
{
    copy(other);
}
...
DeleteContextAppAckMessageDescriptor::DeleteContextAppAckMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeleteContextAppAckMessage)), "simu5g::UalcmpMessage")
{
    propertyNames = nullptr;
}

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/mec/orchestrator/messages/MecOrchestratorMessages.msg.
//
...
MecOrchestratorMessageDescriptor::MecOrchestratorMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::MecOrchestratorMessage)), "omnetpp::cMessage")
{
...
CreateAppMessageDescriptor::CreateAppMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::CreateAppMessage)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
DeleteAppMessageDescriptor::DeleteAppMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeleteAppMessage)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/mec/platform/services/messages/HttpMessages.msg.
//
...
std::string HttpBaseMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_state: return enum2string(static_cast<int>(pp->getState()), "simu5g::HttpRequestState");
        case FIELD_isReceivingMsg: return bool2string(pp->isReceivingMsg());
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "simu5g::HttpMsgType");

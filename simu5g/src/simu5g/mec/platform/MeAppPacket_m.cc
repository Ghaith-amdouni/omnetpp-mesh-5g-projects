//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/mec/platform/MeAppPacket.msg.
//
...
MeAppPacketDescriptor::MeAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::MeAppPacket)), "inet::FieldsChunk")
{

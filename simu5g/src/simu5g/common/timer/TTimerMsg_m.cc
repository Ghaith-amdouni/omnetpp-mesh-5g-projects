//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/common/timer/TTimerMsg.msg.
//
...
std::string TTimerMsgDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: return enum2string(static_cast<int>(pp->getType()), "simu5g::TTimerType");
        default: return "";
    }
}

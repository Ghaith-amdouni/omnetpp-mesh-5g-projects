...
#include "simu5g/common/timer/TTimerMsg_m.h" // import simu5g.common.timer.TTimerMsg


namespace simu5g {

/**
 * Class generated from <tt>simu5g/common/timer/TMultiTimerMsg.msg:17</tt> by opp_msgtool.
 * <pre>

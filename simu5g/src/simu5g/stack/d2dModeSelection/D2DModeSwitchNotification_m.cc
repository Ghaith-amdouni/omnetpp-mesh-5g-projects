//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/stack/d2dModeSelection/D2DModeSwitchNotification.msg.
//
...
MacNodeId D2DModeSwitchNotification::getPeerId() const
{
    return this->peerId;
}

void D2DModeSwitchNotification::setPeerId(MacNodeId peerId)
{
    handleChange();
    this->peerId = peerId;
}
...
D2DModeSwitchNotificationDescriptor::D2DModeSwitchNotificationDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::D2DModeSwitchNotification)), "inet::FieldsChunk")
{
...
const char *D2DModeSwitchNotificationDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "simu5g::MacNodeId",    // FIELD_peerId
        "bool",    // FIELD_txSide
        "simu5g::LteD2DMode",    // FIELD_oldMode
        "simu5g::LteD2DMode",    // FIELD_newMode
...
const char *D2DModeSwitchNotificationDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    ...
    switch (field) {
        case FIELD_oldMode:
            if (!strcmp(propertyName, "enum")) return "simu5g::LteD2DMode";
            return nullptr;
        case FIELD_newMode:
            if (!strcmp(propertyName, "enum")) return "simu5g::LteD2DMode";
            return nullptr;
...
std::string D2DModeSwitchNotificationDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    D2DModeSwitchNotification *pp = omnetpp::fromAnyPtr<D2DModeSwitchNotification>(object); (void)pp;
    switch (field) {
        case FIELD_peerId: return int642string(num(pp->getPeerId()));
        case FIELD_txSide: return bool2string(pp->getTxSide());
        case FIELD_oldMode: return enum2string(static_cast<int>(pp->getOldMode()), "simu5g::LteD2DMode");
        case FIELD_newMode: return enum2string(static_cast<int>(pp->getNewMode()), "simu5g::LteD2DMode");
...
void D2DModeSwitchNotificationDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    D2DModeSwitchNotification *pp = omnetpp::fromAnyPtr<D2DModeSwitchNotification>(object); (void)pp;
    switch (field) {
        case FIELD_peerId: pp->setPeerId(MacNodeId(string2int64(value))); break;
...
omnetpp::cValue D2DModeSwitchNotificationDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    D2DModeSwitchNotification *pp = omnetpp::fromAnyPtr<D2DModeSwitchNotification>(object); (void)pp;
    switch (field) {
        case FIELD_peerId: return num(pp->getPeerId());
...
void D2DModeSwitchNotificationDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    D2DModeSwitchNotification *pp = omnetpp::fromAnyPtr<D2DModeSwitchNotification>(object); (void)pp;
    switch (field) {
        case FIELD_peerId: pp->setPeerId(MacNodeId(value.intValue())); break;

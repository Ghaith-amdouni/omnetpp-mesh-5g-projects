...
/**
 * Class generated from <tt>simu5g/stack/d2dModeSelection/D2DModeSwitchNotification.msg:19</tt> by opp_msgtool.
 * <pre>
...
class D2DModeSwitchNotification : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual MacNodeId getPeerId() const;
    virtual void setPeerId(MacNodeId peerId);

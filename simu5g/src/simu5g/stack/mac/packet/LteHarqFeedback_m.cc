//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/stack/mac/packet/LteHarqFeedback.msg.
//
...
MacNodeId LteHarqFeedbackMirror::getD2dSenderId() const
{
    return this->d2dSenderId;
}

void LteHarqFeedbackMirror::setD2dSenderId(MacNodeId d2dSenderId)
{
    handleChange();
    this->d2dSenderId = d2dSenderId;
}

MacNodeId LteHarqFeedbackMirror::getD2dReceiverId() const
{
    return this->d2dReceiverId;
}

void LteHarqFeedbackMirror::setD2dReceiverId(MacNodeId d2dReceiverId)
{
    handleChange();
...
std::string LteHarqFeedbackMirrorDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteHarqFeedbackMirror *pp = omnetpp::fromAnyPtr<LteHarqFeedbackMirror>(object); (void)pp;
    switch (field) {
        case FIELD_d2dSenderId: return int642string(num(pp->getD2dSenderId()));
        case FIELD_d2dReceiverId: return int642string(num(pp->getD2dReceiverId()));
...
void LteHarqFeedbackMirrorDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    LteHarqFeedbackMirror *pp = omnetpp::fromAnyPtr<LteHarqFeedbackMirror>(object); (void)pp;
    switch (field) {
        case FIELD_d2dSenderId: pp->setD2dSenderId(MacNodeId(string2int64(value))); break;
        case FIELD_d2dReceiverId: pp->setD2dReceiverId(MacNodeId(string2int64(value))); break;
...
omnetpp::cValue LteHarqFeedbackMirrorDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteHarqFeedbackMirror *pp = omnetpp::fromAnyPtr<LteHarqFeedbackMirror>(object); (void)pp;
    switch (field) {
        case FIELD_d2dSenderId: return num(pp->getD2dSenderId());
        case FIELD_d2dReceiverId: return num(pp->getD2dReceiverId());
...
void LteHarqFeedbackMirrorDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    LteHarqFeedbackMirror *pp = omnetpp::fromAnyPtr<LteHarqFeedbackMirror>(object); (void)pp;
    switch (field) {
        case FIELD_d2dSenderId: pp->setD2dSenderId(MacNodeId(value.intValue())); break;
        case FIELD_d2dReceiverId: pp->setD2dReceiverId(MacNodeId(value.intValue())); break;

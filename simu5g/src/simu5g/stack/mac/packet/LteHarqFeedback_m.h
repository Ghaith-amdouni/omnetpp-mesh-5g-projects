...
/**
 * Class generated from <tt>simu5g/stack/mac/packet/LteHarqFeedback.msg:19</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>simu5g/stack/mac/packet/LteHarqFeedback.msg:34</tt> by opp_msgtool.
 * <pre>
...
class LteHarqFeedbackMirror : public ::simu5g::LteHarqFeedback
{
  ...
  public:
    ...
    virtual MacNodeId getD2dSenderId() const;
    virtual void setD2dSenderId(MacNodeId d2dSenderId);

    virtual MacNodeId getD2dReceiverId() const;
    virtual void setD2dReceiverId(MacNodeId d2dReceiverId);

...
LteRlcAmPdu::LteRlcAmPdu() : ::LteRlcPdu()
{
}

LteRlcAmPdu::LteRlcAmPdu(const LteRlcAmPdu& other) : ::LteRlcPdu(other)
{
    copy(other);
}

LteRlcAmPdu::~LteRlcAmPdu()
{
}

LteRlcAmPdu& LteRlcAmPdu::operator=(const LteRlcAmPdu& other)
{
...
void LteRlcAmPdu::copy(const LteRlcAmPdu& other)
{
...
void LteRlcAmPdu::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void LteRlcAmPdu::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
unsigned short LteRlcAmPdu::getAmType() const
{
    return this->amType;
}

void LteRlcAmPdu::setAmType(unsigned short amType)
{
    handleChange();
    this->amType = amType;
}

unsigned short LteRlcAmPdu::getTxNumber() const
{
    return this->txNumber;
}

void LteRlcAmPdu::setTxNumber(unsigned short txNumber)
{
    handleChange();
    this->txNumber = txNumber;
}

int LteRlcAmPdu::getFirstSn() const
{
    return this->firstSn;
}

void LteRlcAmPdu::setFirstSn(int firstSn)
{
    handleChange();
    this->firstSn = firstSn;
}

int LteRlcAmPdu::getLastSn() const
{
    return this->lastSn;
}

void LteRlcAmPdu::setLastSn(int lastSn)
{
    handleChange();
    this->lastSn = lastSn;
}
...
LteRlcAmPduDescriptor::LteRlcAmPduDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::LteRlcAmPdu)), "LteRlcPdu")
{
...
{
    return dynamic_cast<LteRlcAmPdu *>(obj)!=nullptr;
}
...
const char *LteRlcAmPduDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    ...
    switch (field) {
        case FIELD_amType:
            ...
            if (!strcmp(propertyName, "enum")) return "simu5g::LteAmType";
            return nullptr;
        case FIELD_bitmap:
...
int LteRlcAmPduDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    LteRlcAmPdu *pp = omnetpp::fromAnyPtr<LteRlcAmPdu>(object); (void)pp;
    switch (field) {
...
void LteRlcAmPduDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'LteRlcAmPdu'", field);
    }
}
...
std::string LteRlcAmPduDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteRlcAmPdu *pp = omnetpp::fromAnyPtr<LteRlcAmPdu>(object); (void)pp;
    switch (field) {
        case FIELD_amType: return enum2string(static_cast<int>(pp->getAmType()), "simu5g::LteAmType");
...
void LteRlcAmPduDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    LteRlcAmPdu *pp = omnetpp::fromAnyPtr<LteRlcAmPdu>(object); (void)pp;
    switch (field) {
        case FIELD_amType: pp->setAmType((simu5g::LteAmType)string2enum(value, "simu5g::LteAmType")); break;
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'LteRlcAmPdu'", field);
    }
}
...
omnetpp::cValue LteRlcAmPduDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'LteRlcAmPdu' as cValue -- field index out of range?", field);
    }
}
...
void LteRlcAmPduDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    LteRlcAmPdu *pp = omnetpp::fromAnyPtr<LteRlcAmPdu>(object); (void)pp;
    switch (field) {
        case FIELD_amType: pp->setAmType((simu5g::LteAmType)value.intValue()); break;

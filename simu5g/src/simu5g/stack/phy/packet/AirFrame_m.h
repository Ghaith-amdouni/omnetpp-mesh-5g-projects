...
#ifndef __SIMU5G_AIRFRAME_M_H
#define __SIMU5G_AIRFRAME_M_H
...
#include "simu5g/stack/phy/packet/ModulationType_m.h" // import simu5g.stack.phy.packet.ModulationType


namespace simu5g {

/**
 * Class generated from <tt>simu5g/stack/phy/packet/AirFrame.msg:26</tt> by opp_msgtool.
 * <pre>
 * //
 ...
 *     inet::Coord senderPos \@nopack;
 *     inet::GHz carrierFrequency;
 *     double bandwidth;
 *     ModulationType modulationType \@nopack;
 * }
 * </pre>
 */
...
template<> inline simu5g::AirFrame *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::AirFrame*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __SIMU5G_AIRFRAME_M_H

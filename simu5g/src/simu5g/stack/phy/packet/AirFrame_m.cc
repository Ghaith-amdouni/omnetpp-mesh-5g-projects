//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/stack/phy/packet/AirFrame.msg.
//
...
::inet::GHz AirFrame::getCarrierFrequency() const
{
    return this->carrierFrequency;
}

void AirFrame::setCarrierFrequency(::inet::GHz carrierFrequency)
{
...
AirFrameDescriptor::AirFrameDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::AirFrame)), "omnetpp::cPacket")
{
...
const char *AirFrameDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "simu5g::ModulationType",    // FIELD_modulationType
    };
...
const char **AirFrameDescriptor::getFieldPropertyNames(int field) const
{
    ...
    switch (field) {
        case FIELD_senderPos: {
            static const char *names[] = { "nopack",  nullptr };
            return names;
        }
        case FIELD_modulationType: {
            static const char *names[] = { "nopack",  nullptr };
            return names;
        }

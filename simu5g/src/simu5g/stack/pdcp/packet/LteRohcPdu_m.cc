//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/stack/pdcp/packet/LteRohcPdu.msg.
//
...
LteRohcPduDescriptor::LteRohcPduDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::LteRohcPdu)), "inet::FieldsChunk")
{

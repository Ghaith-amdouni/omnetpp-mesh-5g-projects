...
DestinationIdListDescriptor::DestinationIdListDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DestinationIdList)), "")
{
...
MacNodeId X2ControlInfoTag::getSourceId() const
{
    return this->sourceId;
}

void X2ControlInfoTag::setSourceId(MacNodeId sourceId)
{
...
X2ControlInfoTagDescriptor::X2ControlInfoTagDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::X2ControlInfoTag)), "inet::TagBase")
{
    propertyNames = nullptr;
}
...
const char *X2ControlInfoTagDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "simu5g::DestinationIdList",    // FIELD_destIdList
        "bool",    // FIELD_init
    };

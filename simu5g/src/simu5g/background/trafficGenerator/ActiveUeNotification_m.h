...
#ifndef __SIMU5G_ACTIVEUENOTIFICATION_M_H
#define __SIMU5G_ACTIVEUENOTIFICATION_M_H
...
/**
 * Class generated from <tt>simu5g/background/trafficGenerator/ActiveUeNotification.msg:15</tt> by opp_msgtool.
 * <pre>
...
template<> inline simu5g::ActiveUeNotification *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::ActiveUeNotification*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __SIMU5G_ACTIVEUENOTIFICATION_M_H

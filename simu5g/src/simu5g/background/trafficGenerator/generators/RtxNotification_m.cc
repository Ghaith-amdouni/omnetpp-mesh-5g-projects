//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/background/trafficGenerator/generators/RtxNotification.msg.
//
...
RtxNotificationDescriptor::RtxNotificationDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::RtxNotification)), "omnetpp::cMessage")
{

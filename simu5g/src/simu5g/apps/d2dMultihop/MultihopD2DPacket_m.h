...
/**
 * Class generated from <tt>simu5g/apps/d2dMultihop/MultihopD2DPacket.msg:29</tt> by opp_msgtool.
 * <pre>
 * //
 * // MultihopD2DPacket
 * //
...
class MultihopD2DPacket : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual MacNodeId getSrcId() const;
    virtual void setSrcId(MacNodeId srcId);
    ...
    virtual MacNodeId getLastHopSenderId() const;
    virtual void setLastHopSenderId(MacNodeId lastHopSenderId);

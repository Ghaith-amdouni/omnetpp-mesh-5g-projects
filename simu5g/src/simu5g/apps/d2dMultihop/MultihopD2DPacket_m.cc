//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/d2dMultihop/MultihopD2DPacket.msg.
//
...
MacNodeId MultihopD2DPacket::getSrcId() const
{
    return this->srcId;
}

void MultihopD2DPacket::setSrcId(MacNodeId srcId)
{
    handleChange();
    this->srcId = srcId;
}
...
MacNodeId MultihopD2DPacket::getLastHopSenderId() const
{
    return this->lastHopSenderId;
}

void MultihopD2DPacket::setLastHopSenderId(MacNodeId lastHopSenderId)
{
    handleChange();
...
MultihopD2DPacketDescriptor::MultihopD2DPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::MultihopD2DPacket)), "inet::FieldsChunk")
{
...
std::string MultihopD2DPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    MultihopD2DPacket *pp = omnetpp::fromAnyPtr<MultihopD2DPacket>(object); (void)pp;
    switch (field) {
        case FIELD_srcId: return int642string(num(pp->getSrcId()));
        ...
        case FIELD_lastHopSenderId: return int642string(num(pp->getLastHopSenderId()));
...
void MultihopD2DPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    MultihopD2DPacket *pp = omnetpp::fromAnyPtr<MultihopD2DPacket>(object); (void)pp;
    switch (field) {
        case FIELD_srcId: pp->setSrcId(MacNodeId(string2int64(value))); break;
        ...
        case FIELD_lastHopSenderId: pp->setLastHopSenderId(MacNodeId(string2int64(value))); break;
...
omnetpp::cValue MultihopD2DPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    MultihopD2DPacket *pp = omnetpp::fromAnyPtr<MultihopD2DPacket>(object); (void)pp;
    switch (field) {
        case FIELD_srcId: return num(pp->getSrcId());
        ...
        case FIELD_lastHopSenderId: return num(pp->getLastHopSenderId());
...
void MultihopD2DPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    MultihopD2DPacket *pp = omnetpp::fromAnyPtr<MultihopD2DPacket>(object); (void)pp;
    switch (field) {
        case FIELD_srcId: pp->setSrcId(MacNodeId(value.intValue())); break;
        ...
        case FIELD_lastHopSenderId: pp->setLastHopSenderId(MacNodeId(value.intValue())); break;

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/vod/VoDPacket.msg.
//
...
VoDPacketDescriptor::VoDPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::VoDPacket)), "inet::FieldsChunk")
{

//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/vod/M1Message.msg.
//
...
M1MessageDescriptor::M1MessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::M1Message)), "omnetpp::cMessage")
{

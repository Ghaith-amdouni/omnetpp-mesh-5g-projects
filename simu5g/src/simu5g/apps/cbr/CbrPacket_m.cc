//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/cbr/CbrPacket.msg.
//
...
CbrPacketDescriptor::CbrPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::CbrPacket)), "inet::FieldsChunk")
{

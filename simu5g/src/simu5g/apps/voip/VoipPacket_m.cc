//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/voip/VoipPacket.msg.
//
...
VoipPacketDescriptor::VoipPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::VoipPacket)), "inet::FieldsChunk")
{

...
#ifndef __SIMU5G_BURSTPACKET_M_H
#define __SIMU5G_BURSTPACKET_M_H
...
/**
 * Class generated from <tt>simu5g/apps/burst/BurstPacket.msg:21</tt> by opp_msgtool.
 * <pre>
 * //
...
template<> inline simu5g::BurstPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::BurstPacket*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __SIMU5G_BURSTPACKET_M_H

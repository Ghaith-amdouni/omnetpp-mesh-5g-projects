//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/burst/BurstPacket.msg.
//
...
BurstPacketDescriptor::BurstPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::BurstPacket)), "inet::FieldsChunk")
{

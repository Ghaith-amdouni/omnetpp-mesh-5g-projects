//
// Generated file, do not edit! Created by opp_msgtool 6.3 from simu5g/apps/mec/WarningAlert/packets/WarningAlertPacket.msg.
//
...
int WarningAlertPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "positionZ") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "danger") == 0) return baseIndex + 3;
    return base ? base->findField(fieldName) : -1;
}
